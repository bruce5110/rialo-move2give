...
const dashboardActivityMockData = {
  ...
  monthly: {
    ...
    June: {
      label: "June",
      title: "June 2026",
      summary: { activeDays: "3", activeTrend: "Early month data", time: "2 h 05 m", timeTrend: "June has just started", calories: "1,120 kcal", caloriesTrend: "Early month data", score: "78", scoreTrend: "Initial June score" },
      rings: { movement: 70, consistency: 60, recovery: 82, total: 78 },
      labels: ["1", "2", "3"],
      axisLabels: ["Jun 1", "Jun 2", "Jun 3"],
      workoutCards: {
        walking: ["16,960 steps", "11.5 km · 3 days"],
        running: ["3.4 km", "Avg pace 6'26\"/km"],
        cycling: ["18.2 km", "Avg speed 18.2 km/h"],
        swimming: ["0.4 km", "8 laps · 10 min"],
        strength: ["7 sets", "2 sessions · 52m"],
      },
      chartValues: {
        walking: [4920, 5940, 6100],
        running: [0, 3.4, 0],
        cycling: [8.8, 0, 9.4],
        swimming: [0, 8, 0],
        strength: [4, 0, 3],
  ...
  yearly: {
    label: "This Year",
    title: "May → June 2026",
    summary: { activeDays: "21", activeTrend: "May + June summary", time: "14 h 39 m", timeTrend: "Year-to-date demo", calories: "6,762 kcal", caloriesTrend: "Year-to-date demo", score: "85", scoreTrend: "Strong YTD activity" },
    rings: { movement: 85, consistency: 79, recovery: 80, total: 85 },
    labels: ["May", "June"],
    axisLabels: ["May", "June"],
    workoutCards: {
      walking: ["85,380 steps", "57.7 km · 21 days"],
      running: ["24.7 km", "Avg pace 6'21\"/km"],
      cycling: ["50.0 km", "Avg speed 18.4 km/h"],
      swimming: ["2.8 km", "56 laps · 62 min"],
      strength: ["25 sets", "7 sessions · 4h 02m"],
    },
    chartValues: {
      walking: [68420, 16960],
      running: [21.3, 3.4],
